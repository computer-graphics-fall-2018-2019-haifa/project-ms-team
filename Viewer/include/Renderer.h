...
private:
	...
	void drawModel(const std::vector<Face>& faces, const std::vector<glm::vec3>&, const glm::vec4& color,
		...
		float KA, float KD, float KS, const glm::vec3& cameraPos, const glm::mat4& mat, bool rainbow = false, bool circles = false, bool aliasing = false);
